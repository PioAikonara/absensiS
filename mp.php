...
<head>
    ...
    <title>Manajemen Perkantoran - SMKN 40 Jakarta</title>
...
<div class="content w-100 d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="container text-center">
        <h2 class="mb-4">Manajemen Perkantoran</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title mb-3">
                            ...
                            Tentang Jurusan Manajemen Perkantoran
                        </h3>
                        <p class="card-text">
                            Manajemen Perkantoran adalah program keahlian yang mempersiapkan siswa untuk menjadi 
                            tenaga profesional dalam pengelolaan administrasi perkantoran modern. Program ini 
                            memfokuskan pada manajemen dokumen, komunikasi bisnis, dan operasional kantor.
                        </p>
                    </div>
                </div>
            </div>
